...
class Line(object):
    ...
    def __eq__(self,ell):
        ...
        if self.normal_vector.is_zero():
            if not ell.normal_vector.is_zero():
                ...
                diff = slef.constant_term - ell.constant_term
    ...
    def is_parallel_to(self,ell):
        ...
        return n1.normalized().is_parallel_to(n2.normalized())
...
#ell2 = Line(normal_vector=Vector(['4.046','2.836']),constant_term='1.21')
